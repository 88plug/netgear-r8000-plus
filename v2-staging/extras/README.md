...
| 3 | `radio-watchdog/` | **Include, with the caveat documented in its NOTES.md** | This is the single highest-value fix for the R8000's most-reported OpenWrt complaint (radios wedging, #14685/#20514, already called out in this repo's own docs/RUNBOOK.md). Tested live end-to-end including a real reboot-and-recover cycle. The known simplification (module reload resets all 3 radios together, not just the wedged one) is accepted scope, not a shortcut. |
