...
| 3 | UART/serial console hardware research | R8000 board-level UART header/pads, baud rate, pinout, and any CFE bootloader serial-console access path (recovery net item, ties into the "TFTP needs serial" caveat already in `docs/RUNBOOK.md`) | closed 2026-07-24 — moot, see "Closing out threads 3-6" below |
